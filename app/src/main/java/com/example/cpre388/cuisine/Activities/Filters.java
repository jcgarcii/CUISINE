...
public class Filters {
    ...
    public static Filters getDefault() {
        ...
        filters.setSortBy(restaurant_model.FIELD_AVG_RATING);
    ...
    public String getOrderDescription(Context context) {
        if (restaurant_model.FIELD_PRICE.equals(sortBy)) {
            return context.getString(R.string.sorted_by_price);
        } else if (restaurant_model.FIELD_POPULARITY.equals(sortBy)) {
